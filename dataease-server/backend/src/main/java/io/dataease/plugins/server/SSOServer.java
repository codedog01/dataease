...
public class SSOServer {
    ...
    @GetMapping("/callBack")
    public ModelAndView callBack(@RequestParam("code") String code, @RequestParam("state") String state,@RequestParam("route") String route) {
        ModelAndView modelAndView = new ModelAndView("redirect:" + route);
